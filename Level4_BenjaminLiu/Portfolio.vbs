...
If strInstrumentType = "Portfolio" Then strInstrumentType = "FX"
Dates = Dates_OneClass(strInstrumentType)
ReDim returns(1 To Dates-1)
...
Function retun(strInstrumentType As String) As Double
' ==================================================================================================
' ARGUMENTS:
' strInstrumentType --string, the Instrument Type
' RETURNS:
...
ret = WorksheetFunction.Average(returns)
