...
Function BondPirce(discountRate as double, nper as integer, freq as double, couponRate as double, notional as double) as double
' ==================================================================================================
' ARGUMENTS:
...
Dim i As Integer
pv=0.0
pmt = notional * couponMargin / freq
